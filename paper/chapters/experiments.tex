...
W badaniach pominięto wyniki heurystyki, ponieważ jej czas wykonania był
znacznie dłuższy w porównaniu z pozostałymi algorytmami. W praktyce
uniemożliwiało to przeprowadzenie testów dla tych samych zakresów
parametrów oraz czytelne przedstawienie wyników na wspólnych wykresach.
