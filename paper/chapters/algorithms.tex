...
Podejście brute force polega na sprawdzeniu calej przestrzeni przeszukiwań, tzn. zapełnienia brakujących przejść w automacie kazda mozliwą ich kombinacją, a następnie zasymulowania kadej z próbek i sprawdzeniu czy kończy w stanie zgodnym z danymi wejściowymi.
...
Heurystyka polega na algorytmie hill climbing z losowymi restartami, w której funkcja celu to minimalizowanie liczby próbek, które kończą niepoprawnie względem danych wejściowych.

% old version of descprition hill climbing
% \subsection{Heurystyka naprawy automatu z losowymi restartami}
