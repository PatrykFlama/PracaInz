...
\begin{fact}
Poniższy problem \textit{najmniejszego zgodnego automatu} jest NP-zupełny \cite{grammatical_inference}:
...
Poprowadzenie brakującej krawędzi do dowolnego stanu który nie jest $s_i$ lub $sink_+$ doprowadzi do $\text{sink}_-$ po przejściu następną literą $t$.\\
