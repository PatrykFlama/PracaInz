...
$$\forall{x, y \in {1..k} \and x \neq y} \forall{i, j \in {1..n}} (\delta(q_{\lambda}, p_x) = v_i \and \delta(q_{\lambda}, p_y) = v_j) \implies (i \neq j)$$
...
$$\forall{x, y \in {1..k}, x \neq y} \forall{i, j \in {1..n}} (\delta(q_{\lambda}, p_x) = v_i \and \delta(q_{\lambda}, p_y) = v_j) \implies ((v_i, v_j) \in E)$$
