...
% TODO: why we can solve problem of exactly k-clique instead of at least k-clique
...
% TODO: wypadałoby się upewnić że wszędzie gdzie miałem napisać STAN (w automacie) to napisałem stan, a tam gdize miałem napisać WIERZCHOŁEK (w grafie) to napisałem wierzchołek
...
%! TODO FIXME: the edge c leading to sink+ - its impossible, instead we should:
% 1. move edge t to after the bin stage
% 2. explain why it still 'works'
% 3. ensure that missing edges leading to q_lambda are rejected (they are, since next letter is 0/1 and to sink+ leads t)
...
%! TODO FIXME: missing edges can still lead to q_lambda, where any number of 1s will result in success
% solution: add rejecting samples that will ensure we land in rejecting vertice after taking the missing edge
...
% TODO: why we can solve problem of exactly k-set cover instead of at most k-set cover
...
\import{theory/figures}{reduction_ksetcover}
