% TODO Potrzebne wprowadzenie do rozdziału, np. "W tym rozdziale podamy deﬁnicje..."
...
\begin{itemize}
    ...
    \item niektóre stany $q$ mogły zostać usunięte z automatu (brakujące stany), więc nie należą one ani do $\mathbb{F_A}$, ani do $\mathbb{F_R}$,
\end{itemize}
