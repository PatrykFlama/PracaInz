...
\begin{tikzpicture}[
    ...
    \draw[->,thick] (s) -- (sink) node[midway,above] {choice};
    ...
    \node[draw,state,inner sep=2pt] (choice1) at (10.5,-0.8) {$S$};
