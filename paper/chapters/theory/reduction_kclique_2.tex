...
\begin{tikzpicture}[
    ...
    \node[draw,state,inner sep=2pt] (s) at (0,0) {$S$};
    ...
    \node[draw,state,inner sep=2pt] (u1s) at (6,-7) {$S$};
    \node[draw,state,inner sep=2pt] (uis) at (10,-7) {$S$};
    \node[draw,state,inner sep=2pt] (uns) at (14,-7) {$S$};
    ...
    \node[draw,state,inner sep=2pt] (w1s) at (6,-11) {$S$};
    \node[draw,state,inner sep=2pt] (wns) at (14,-11) {$S$};
