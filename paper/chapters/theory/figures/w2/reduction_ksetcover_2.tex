...
\begin{tikzpicture}[
    ...
    % sinki
    \node[draw,accept,inner sep=1.5pt] (sinkp) at (0,-3) {$\text{sink}_+$};
    \draw[->,thick] (s) -- (sinkp) node[midway,right] {$1$};
    \node[draw,reject,inner sep=1.5pt] (sinkn) at (0,-5) {$\text{sink}_-$};
    ...
    \node[draw,accept,inner sep=2pt] (inset) at (9,-7) {$ $};
    \node[draw,reject,inner sep=2pt] (outset) at (11,-7) {$ $};
