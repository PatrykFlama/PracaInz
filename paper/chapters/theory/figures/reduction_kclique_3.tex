...
\begin{tikzpicture}[
    ...
    % sekcja wyboru
    \node[draw,state,inner sep=2pt] (test) at (8,-2) {$ $};
    \draw[->,thick] (vvi) -- (test) node[midway,above] {$c$};

    \node[draw,tostart,inner sep=2pt] (choice1) at (10,-1.1) {$q_{\lambda}$};
    \node[draw,state,inner sep=2pt] (choice2) at (10,-2.7) {$c_2$};
    \draw[->,thick] (test) -- (choice1) node[midway,above] {$0$};
    \draw[->,thick] (test) -- (choice2) node[midway,above] {$1$};
