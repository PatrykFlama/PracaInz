...
\begin{tikzpicture}[
    ...
    \node[draw,accept,inner sep=1.5pt] (sinkp) at (0,-3) {$sink_+$};
    \draw[->,thick] (s) -- (sinkp) node[midway,right] {$1$};
    \node[draw,reject,inner sep=1.5pt] (sinkn) at (0,-5) {$sink_-$};
    ...
    \node[draw,tostart,inner sep=2pt] (u1s) at (6,-7) {$q_{\lambda}$};
    \node[draw,tostart,inner sep=2pt] (uis) at (10,-7) {$q_{\lambda}$};
    \node[draw,tostart,inner sep=2pt] (uns) at (14,-7) {$q_{\lambda}$};
    ...
    \node[draw,tostart,inner sep=2pt] (w1s) at (6,-11) {$q_{\lambda}$};
    \node[draw,tostart,inner sep=2pt] (wns) at (14,-11) {$q_{\lambda}$};

    \draw[->,thick] (w1) -- (w1s) node[midway,right] {$3*1$};
    \draw[->,thick] (wn) -- (wns) node[midway,right] {$3*1$};

    % warstwa sąsiedztwa
    \node[draw,state,inner sep=2pt] (neigh1) at (10,-13) {$n_0$};
