...
\begin{tikzpicture}[
    ...
    % krawędź choice
    \node[draw,state,inner sep=2pt] (test_edge) at (6,-1.6) {$ $};
    \draw[->,thick] (vi) -- (test_edge) node[midway,above] {$\text{test}$};
    ...
    \node[
        ...
        thick,
        rounded corners,
        fit=(vv1)(vvi)(vvn)(choice1)(choice2)(accept)(reject)(test_edge),
