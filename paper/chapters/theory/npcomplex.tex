Aby wykazać że problem naprawiania częściowego DFA \ref{def:fixpartialdfa} jest NP-zupełny, musimy udowodnić, że należy do klasy NP oraz że jest NP-trudny.
...
\begin{fact}
Problem \textit{najmniejszego zgodnego automatu} jest NP-zupełny \cite{grammatical_inference}:
\end{fact}
...
\begin{lemma}
[Problem naprawienia częściowego DFA jest NP-trudny]
\end{lemma}
