...
Dla $i$-tego stanu w ciągu, krawędź etykietowana $1$ jest wybrakowanym przejściem w automaciem - które będziemy chcieli prowadzić tylko i wyłącznie do stanów $s_i$. 
Długość ciągu wynosi $k$, bo $i$-ty stan w ciągu odpowiada krawędzi $p_i$ z poprzedniej konstrukcji, a takich krawędzi jest $k$.

Następnie z każdego stanu $s_i$ wychodzi ciąg $10$ krawędzi z etykietą $1$, łączących stany, które odpowiadających krawędzi testowej $t$ (taki ciąg nie wystąpuje nigdzie indziej w automacie, poza stanem $\text{sink}_+$). 
